...
<svg id=logo width='100' height='100' clip-path='inset(0% round 15px)' viewBox='0 0 38.100037 38.100006'>
...
<div id=paranoid style="position: absolute;  top: 50%; left: 50%;  transform: translate(-50%, -50%); font-weight: bold; font-size: 60pt"></div>
</div>
<p></p>
	<div id=info>...</div>
    <p>
    <b><i>For our paranoid androids:<br></b>
    check that a few consequitive random numbers show in the logo are identical<br>
    to the sequence you see on the OLED screen of the reader. <br>
    <p>
    While it should not, this may give you a teeny bit of confort that there is, or has been, no evil maid in the room.<br>
   </center>
   </body>
  <script language='javascript'>
     var aliveTimeout;
     var info, paranoid, logo;
     ...
     function resetKeepAlive() {
         ...
         aliveTimeout = setTimeout(initWebSocket, 30*1000);
     };

     function onload(event) { 
        info = document.getElementById('info');
        paranoid = document.getElementById('paranoid');
